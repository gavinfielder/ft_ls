...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/04/10 18:30:21 by gfielder          #+#    #+#              #
#    Updated: 2019/04/22 18:09:23 by gfielder         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME=ft_ls
SRC=src/cmp.c src/tree.c src/file.c src/options.c src/output.c \
	src/static_queue.c src/output_h.c src/tty.c src/utils.c \
	src/output_l.c src/cmp_time.c src/output_h_2.c src/error.c \
	src/output_l_opt.c src/noop.c src/file_2.c
SRC_MAIN=src/main.c
...
clean:
	@make gut_clean
	@make -C lib/libft/ clean > /dev/null 2>&1

fclean:
	@rm -f $(NAME)
	@make gut_fclean
	@make -C lib/libft/ fclean > /dev/null 2>&1
